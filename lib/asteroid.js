(function() {
  ...
  Asteroid.prototype.draw = function(ctx) {
    // this draws the asteroid as a circle, which helps calibrate collisions
    // ctx.fillStyle = '#cc5500';
    // ctx.beginPath();
    // ctx.arc(this.pos[0], this.pos[1], Asteroid.RADIUS, 0, 2 * Math.PI, true);
    // ctx.fill();
    ...
    ctx.drawImage(
      ...
      this.pos[0] - 70, // destination x
      this.pos[1] - 70, // destination y
      Asteroid.RADIUS * 2.75, // destination width
      Asteroid.RADIUS * 2.75 // destination height
    );
