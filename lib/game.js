  ...
  Game.prototype.drawIntro = function(ctx) {
    ...
    if(this.pulse >= Asteroids.Game.FPS) {
      ...
      ctx.fillText(
        ...
        Game.DIM_X / 2, Game.DIM_Y / 2 + 65
      );
      this.pulse += 1;
    }

    ctx.font = "20px gameFont";
    ctx.fillText("Controls: ↑↓←→ or w-a-s-d to move, space to shoot", Game.DIM_X / 2, Game.DIM_Y / 2 + 140);
    ...
    ctx.fillStyle = '#FFF';
    ctx.font = '25px Arial'
    ctx.fillText("Source Code: github.com/dwightware4/Asteroids", Game.DIM_X / 2, Game.DIM_Y - 15);
