(function() {
  ...
  Game.prototype.draw = function(ctx) {
    ...
    ctx.fillStyle = '#FFF';
    ctx.font="20px tron";
    ctx.fillText("Score: " + this.score, Game.DIM_X - (50 + (this.score.toString().length * 6)), 30);
  ...
  Game.prototype.drawIntro = function(ctx) {
    ...
    if(this.pulse >= Asteroids.Game.FPS) {
      ...
      ctx.fillText("Press <enter> to Start", Game.DIM_X / 2, Game.DIM_Y / 2 + 100);
      this.pulse += 1;
    }
  ...
  Game.prototype.drawOutro = function(ctx) {
    ...
    ctx.font="25px tron";
    ctx.fillText("Your Score: " + this.score + "!", Game.DIM_X / 2, Game.DIM_Y / 2 + 40);
    ...
    if(this.pulse >= Asteroids.Game.FPS) {
      ...
      ctx.fillText("Press <enter> to Start a New Game", Game.DIM_X / 2, Game.DIM_Y / 2 + 100);
      this.pulse += 1;
    }
