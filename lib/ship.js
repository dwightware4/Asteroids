(function() {
  ...
  Ship.prototype.fireBullet = function() {
    var shipFront = [this.pos[0] + (5 * Math.sin(this.angle * 57.325)), this.pos[1] + (-5 * Math.cos(this.angle * 57.325))];
    var bulletDirection = Asteroids.Util.dir([(shipFront[0] - this.pos[0]), (shipFront[1] - this.pos[1])]);
